...
<link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css'
	rel='stylesheet'>
<link rel="stylesheet" href="style/stylesserviceslogin.css">
...
<body>
	<div class="wrapper">
		<form action="">
			<h1>Services Log in</h1>
			<div class="input-box">
				<input id="username-services" type="text" placeholder="Username"
					required id="username"> <i class='bx bxs-user'></i>
			</div>
			<div class="input-box">
				<input id="password-services" type="password" placeholder="Password"
			...
			<form class="modal-content" action="/action_page.php">
				<div class="container">
					...
					<div class="input-box">
						...
						<label for="quantity">Number of sessions cleaned:</label> <input
